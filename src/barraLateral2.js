...
import user from './assets/fotoProf.jpg';

const BarraLateral = ({ backgroundColor, borderColor, buttonColor }) => {
    const images = [
        { id: 0, name: 'TITO ESTEVEZ', url: user },
        { id: 1, name: 'Informacion del usuario', url: usuario },
        { id: 2, name: 'MATERIAS', url: inscripciones },
    ];
    ...
    const renderContent = () => {
        if (content === 'Informacion del usuario') {
            return (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%', overflowY: 'auto' }}>
                    ...
                    <div style={{ textAlign: 'left', fontSize: '20px' }}>
                        <p><strong>Nombre:</strong> TITO ESTEVEZ </p>
                        <p><strong>Edad:</strong> 52?</p>
                        <p><strong>facultad:</strong> Medicina</p>
                        <p><strong>CI:</strong> 97542616</p>
            ...
            return (
                <>
                    <h1 style={{ textAlign: 'center' }}>Bienvenido al sistema Profesor</h1>
